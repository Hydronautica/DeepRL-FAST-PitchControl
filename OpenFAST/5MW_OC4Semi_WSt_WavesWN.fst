...
"NRELOffshrBsline5MW_InflowWind_Extreme.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
"SB2.dat"      SubFile         - Name of file containing sub-structural input parameters (quoted string)
